 ...
 */
void UstawTest( BazaTestu *wskBazaTestu, Expression *wskTabTestu, unsigned int IloscPytan )
{
...
bool InicjalizujTest( BazaTestu  *wskBazaTestu, const char *sNazwaTestu )
{
  if (!strcmp(sNazwaTestu,"latwy")) {
    UstawTest(wskBazaTestu,TestLatwy,sizeof(TestLatwy)/sizeof(Expression));
    return true;
  }
  else if (!strcmp(sNazwaTestu,"trudny")) {
    UstawTest(wskBazaTestu,TestTrudny,sizeof(TestTrudny)/sizeof(Expression));
    return true;
  }
 ...
 *       false - w przypadku przeciwnym.
 */
bool PobierzNastpnePytanie( BazaTestu  *wskBazaTestu, Expression *wskWyrazenie )
{
